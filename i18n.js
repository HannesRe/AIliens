(() => {
  ...
  const translations = {
    en: {
      ...
      "index.agentMessage": "Hello Agent,<br>AI-liens from the Gemini constellation are trying to take over Earth. They disguise themselves as humans and are hard to tell apart. That is why all agents must complete this training as quickly as possible. Are you ready to save Earth?",
      ...
      "dialog.agentMessage": "Hello Agent,<br>AI-liens from the Gemini constellation are trying to take over Earth. They disguise themselves as humans and are hard to tell apart. That is why all agents must complete this training as quickly as possible. Are you ready to save Earth?",
      ...
      "training.phase1.agentMessage": "Our research team has discovered weaknesses in the AI-liens' technology that can help you. Let's begin with techniques that focus on the face.",
